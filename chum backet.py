...
def menu(callback):
    ...
    try:
        if callback.data == 'Menu':
            ...
            menu_board.add(pizza)
            menu_board.add(beer)
            menu_board.add(slime)
        ...
        # PIZZA CODE
            ...
            pizza_board.add(one)
            pizza_board.add(two)
            pizza_board.add(three)
            pizza_board.add(back)
        ...
        # Pay code
            ...
            markup_order.add(dop_order)
            markup_order.add(pay_order)
        ...
        # Code SMILE
            ...
            back = telebot.types.InlineKeyboardButton(text='back_to_menu', callback_data='back_to_menu')
            smile_board.add(red)
            smile_board.add(yellow)
            smile_board.add(blue)
            smile_board.add(back)
        ...
        # Code BEER
            ...
            back = telebot.types.InlineKeyboardButton(text='back_to_menu', callback_data='back_to_menu')
            beer_board.add(light)
            beer_board.add(dark)
            beer_board.add(white)
            beer_board.add(back)
